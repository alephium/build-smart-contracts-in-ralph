...
class Factory extends ContractFactory<DepositInstance, {}> {
  encodeFields() {
  ...
  tests = {
    deposit: async (
      params: Omit<
        TestContractParamsWithoutMaps<never, { caller: Address }>,
        "initialFields"
      >
...
export const Deposit = new Factory(
  Contract.fromJson(
    DepositContractJson,
    "",
    "132562d775d145ebd284c116f25dafe75d31c4a8fc84623662391ba6aa75d11e",
    AllStructs
  )
);
